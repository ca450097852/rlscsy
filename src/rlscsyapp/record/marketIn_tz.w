...
<title>农产品质量安全追溯平台</title>  
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="false" xid="marketIn_tzData" idColumn="vrId" onCustomRefresh="marketIn_tzDataCustomRefresh" limit="5"><column label="vrId" name="vrId" type="Integer" xid="xid1"></column>
  ...
  <column label="quarantineNum" name="quarantineNum" type="String" xid="xid10"></column>
  <column label="price" name="price" type="String" xid="xid11"></column>
  <column label="amount" name="amount" type="String" xid="xid12"></column>
  <column label="deadNum" name="deadNum" type="String" xid="xid13"></column>
  <column label="checkResult" name="checkResult" type="String" xid="xid14"></column>
  <column label="areaOriginId" name="areaOriginId" type="String" xid="xid15"></column>
  <column label="areaOriginName" name="areaOriginName" type="String" xid="xid16"></column>
  <column label="farmName" name="farmName" type="String" xid="xid17"></column>
  <column label="transporterId" name="transporterId" type="String" xid="xid18"></column>
  <column label="createTime" name="createTime" type="String" xid="xid19"></column></div></div>  
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="生猪进厂记录"
          class="x-titlebar">
          ...
          <div class="x-titlebar-title">生猪进厂记录</div>  
   ...
   <div class="x-scroll-content" xid="div3"><div component="$UI/system/components/justep/list/list" class="x-list x-cards" xid="list1" data="marketIn_tzData" limit="-1" disablePullToRefresh="false" disableInfiniteLoad="false" autoLoad="false">
     ...
     <div class="caption" xid="div2">
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row7">
       <div class="x-col" xid="col7">
        ...
        <span xid="span1" bind-text='ref("quarantineId")'></span></div> </div> 
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row8">
       <div class="x-col" xid="col9">
        <span xid="span14">进场数量：</span>
        <span xid="span13" bind-text='ref("quarantineNum")'></span>
        </div> </div> 
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row10">
   <div class="x-col" xid="col16">
   <span xid="span21"><![CDATA[养殖场名称：]]></span>
   <span xid="span22" bind-text='ref("farmName")'></span>
   </div>
