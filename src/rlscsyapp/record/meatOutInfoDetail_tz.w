...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:242px;top:61px;"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="false"
      xid="meatOutInfoDetailData" idColumn="moidId" limit="5" onCustomRefresh="meatOutInfoDetailDataCustomRefresh">
      <column label="moidId" name="moidId" type="Integer" xid="xid1"/>  
      <column label="moibId" name="moibId" type="Integer" xid="xid2"/>  
      <column label="ptbId" name="tranId" type="String" xid="xid3"/>  
      <column label="quarantineAnimalProductsId" name="quarantineAnimalProductsId"
        type="String" xid="xid4"/>  
      <column label="inspectionMeatId" name="inspectionMeatId" type="String" xid="xid5"/>  
      <column label="tranDate" name="meatCode" type="String" xid="xid7"/>  
      <column label="sellerId" name="meatName" type="String" xid="xid8"/>  
      <column label="weight" name="weight" type="String" xid="xid6"/>  
      <column label="price" name="price" type="String" xid="xid9"/>  
      <column label="dest" name="dest" type="String" xid="xid11"/>
    </div>
  </div>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    xid="panel1"> 
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" title="交易明细信息"
        class="x-titlebar"> 
        ...
        <div class="x-titlebar-title">交易明细信息</div>  
      ...
      <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView"
        ...
        <div class="x-scroll-content" xid="div3">
          <div component="$UI/system/components/justep/list/list" class="x-list x-cards"
            xid="list1" data="meatOutInfoDetailData" limit="-1" disablePullToRefresh="false"
                ...
                <div class="caption" xid="div2"> 
                  <div component="$UI/system/components/justep/row/row" class="x-row"
                    ...
                    <div class="x-col" xid="col5"> 
                      <span xid="span2"><![CDATA[产品检疫合格证号：]]></span>  
                      <span xid="span10" bind-text="ref(&quot;quarantineAnimalProductsId&quot;)"/>
                    </div> 
                  </div>  
                  <div component="$UI/system/components/justep/row/row" class="x-row"
                    xid="row1"> 
                    <div class="x-col" xid="col1"> 
                      <span xid="span4">肉品品质检验证号：</span>  
                      <span xid="span3" bind-text="ref(&quot;inspectionMeatId&quot;)"/>
                    </div> 
                  </div>  
                  <div component="$UI/system/components/justep/row/row" class="x-row"
                    xid="row3"> 
                    <div class="x-col" xid="col2"> 
                      <span xid="span6"><![CDATA[商品编码：]]></span>  
                      <span xid="span5" bind-text="ref(&quot;meatCode&quot;)"/>
                    </div> 
                  </div>  
                  <div component="$UI/system/components/justep/row/row" class="x-row"
                    xid="row4"> 
                    <div class="x-col" xid="col3"> 
                      <span xid="span8">商品名称：</span>  
                      <span xid="span7" bind-text="ref(&quot;meatName&quot;)"/>
                    </div> 
                  </div>  
                  <div component="$UI/system/components/justep/row/row" class="x-row"
                    xid="row5"> 
                    <div class="x-col" xid="col4"> 
                      <span xid="span11">重量：</span>  
                      <span xid="span9" bind-text="ref(&quot;weight&quot;)"/>
                    </div> 
                  </div>  
                  <div component="$UI/system/components/justep/row/row" class="x-row"
                    xid="row7"> 
                    <div class="x-col" xid="col7"> 
                      <span xid="span12"><![CDATA[单价：]]></span>  
                      <span xid="span1" bind-text="ref(&quot;price&quot;)"/>
                    </div> 
                  </div>  
