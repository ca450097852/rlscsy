...
public class PrintPng implements Printable  {
	
	private String Imgpath;
	
	public PrintPng(String Imgpath) {
		System.out.println("*************************");
	...
	public int print(Graphics gra, PageFormat pf, int pageIndex) throws PrinterException {
		...
		case 0:
			...
			System.out.println("----------------------------------------------------------"+Imgpath);
			Image src = Toolkit.getDefaultToolkit().getImage(Imgpath);
