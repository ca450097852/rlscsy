...
<title>广州市肉类蔬菜流通追溯管理平台-企业详情</title>
...
<script src="<%=basePath %>static/js/hontek/portalweb/company_detail.js"　type="text/javascript"></script>
</head>
  
<body>
<input id="basePath" type="hidden" value="<%=basePath %>"/>
<input id="entId" type="hidden" value="<%=entId %>"/>
 ...
 <DIV class="CENTER">
        <div class="CENTER_content">
        	<div class="CENTER_content_left">
            	<div class="product_title"><img src="<%=basePath %>static/image/portalweb/icon.png" /> <font>企业详情</font></div>
