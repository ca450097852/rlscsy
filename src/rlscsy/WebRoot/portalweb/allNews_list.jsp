...
<script src="<%=basePath %>static/js/hontek/portalweb/allNews_list.js"　type="text/javascript"></script>
</head>
 ...
 <DIV class="CENTER">
        <div class="CENTER_content">
        	<div class="CENTER_content_left">
            	<div class="product_title"><img src="<%=basePath %>static/image/portalweb/icon.png" /> <font id="weizhi"><a>新闻发布</a></font></div>
                <div class="news_list" >
                	<ul id="news_list">
                    	<!-- 信息列表部份 -->
                    </ul>
