...
<link type="text/css" rel="stylesheet" href="<%=basePath %>static/css/portalweb/complaint.css"/>
	...
	<script src="<%=basePath %>static/js/hontek/portalweb/complaintOrTongbao_list.js"　type="text/javascript"></script>
</head>
...
<DIV class="CENTER">
       <div class="CENTER_content">
        	<div class="CENTER_content_left">
            	<div class="product_title"><img src="<%=basePath %>static/image/portalweb/icon.png" /> <font id="weizhi">当前位置:<a>新闻发布</a></font></div>
                <div class="news_list" >
