				...
				},
				{
					...
					formatter : function(value, row, index) {						
						return "<a href='javascript:void(0)' onclick='showDetail("+ index+ ")'>查看明细</a>&nbsp;&nbsp;&nbsp;&nbsp;" +
							   "<a href='javascript:void(0)' onclick='showProductImg("+ index+ ")'>产品图片</a>&nbsp;&nbsp;";
...
function showDetail(index) {
	...
	if(row.productInfo&&row.productInfo.length>0){
		var pi = row.productInfo[0];
	...
	var tableHtml = "<tr><td class='form_label' style='width: 15%;'>产品名称：</td><td class='form_value' style='width: 35%;'>"+row.proName+"</td><td class='form_label' style='width: 15%;'>产品分类：</td><td class='form_value' style='width: 35%;'>"+row.typeName+"</td></tr>";
	 
		tableHtml += "<tr><td class='form_label'>是否认证：</td><td class='form_value'>"+certificate+"</td><td class='form_label'>是否检测：</td><td class='form_value'>"+ischeck+"</td></tr>";
		tableHtml += "<tr><td class='form_label'>检测方式：</td><td class='form_value'>"+checkway+"</td><td class='form_label'>检测结果：</td><td class='form_value'>"+checkresult+"</td></tr>";
		tableHtml += "<tr><td class='form_label'>生产基地：</td><td class='form_value'>"+basearea+"</td><td class='form_label'>规模：</td><td class='form_value'>"+scale+"</td></tr>";
		tableHtml += "<tr><td class='form_label'>上市期：</td><td class='form_value'>"+listed+"</td><td class='form_label'>主要销售地：</td><td class='form_value'>"+salearea+"</td></tr>";
		
		tableHtml += "<tr><td class='form_label'>产品包装：</td><td class='form_value'>"+packing+"</td><td class='form_label'>条形码：</td><td class='form_value'>"+row.barcode+"</td></tr>";
		//tableHtml += "<tr><td style='width: 80px;height: 25px'>产品编码：</td><td>"+row.proCode+"</td><td style='width: 80px'>条形码：</td><td>"+row.barcode+"</td></tr>";
		
		tableHtml += "<tr><td class='form_label'>单位规格：</td><td class='form_value'>"+row.unit+"</td><td class='form_label'>生产状态：</td><td class='form_value'>"+state+"</td></tr>";
		
		tableHtml += "<tr><td class='form_label'>储藏条件：</td><td class='form_value'>"+row.storageConditions+"</td><td class='form_label'>保质期：</td><td class='form_value'>"+row.shelfLife+"</td></tr>";
		
		tableHtml += "<tr><td class='form_label'>三品一标一名牌：</td><td class='form_value'>"+row.authentication+"</td><td class='form_label'>保鲜防腐：</td><td class='form_value'>"+row.retain+"</td></tr>";
		
		tableHtml += "<tr><td class='form_label'>生产商：</td><td class='form_value'>"+row.manufacturer+"</td><td class='form_label'>生产商电话：</td><td class='form_value'>"+row.sourceTel+"</td></tr>";
		
		tableHtml += "<tr><td class='form_label'>生产商地址：</td><td class='form_value' colspan='3'>"+row.sourceAddr+"</td></tr>";
		
		tableHtml += "<tr><td class='form_label'>经销商：</td><td class='form_value'>"+row.distributor+"</td><td class='form_label'>经销商电话：</td><td class='form_value'>"+row.distributorTel+"</td></tr>";
		
		tableHtml += "<tr><td class='form_label'>经销商地址：</td><td class='form_value' colspan='3'>"+row.distributorAddr+"</td></tr>";
		
		tableHtml += "<tr><td class='form_label'>产品说明：</td><td class='form_value' colspan='3'><textarea rows='3' style='width: 100%;border: 0'>"+row.proDesc+"</textarea></td></tr>";
		    			
		$("#det").html(tableHtml);			
		
		$('#product_detail').window('open').window('center');

}


function showProductImg(index) {
	var row = $('#productdatagrid').datagrid("getRows")[index];
	...
	//附件
	var productAppend = {};
	productAppend["productAppend.proId"]=row.proId;
	$.ajax({
		...
		success : function(apps) {
			if(apps&&apps.total>0){					
				...
				for(var i=0;i<apps.rows.length;i++){
					...
					liHtml += "<a rel=\"product_group\" href=\""+imgPath+"\" title=\""+app.appName+"\"><img border=0 src=\""+imgPath+"\" height=\"150\" width=\"150\"></a>";							
				}	
				if(liHtml==''){
					liHtml ='暂无图片!'
				}
				...
				$("#productPicBox").html('暂无图片!');																
			}
		}
	});
	
	$('#attachWin').window('open').window('center');
