...
<!--	<script src="${basePath}static/js/jquery/jquery-1.8.0.min.js"　type="text/javascript"></script>-->
	...
	<script src="${basePath}static/js/hontek/info/info.js" type="text/javascript"></script>
	...
	<script type="text/javascript">
		...
		dataGrid = $('#list_info').datagrid( {
			...
			//url : 'info_findInfoList.action?typeid=7',
			...
			{field : 'rsts',title : '状态',width : 150,align : 'center',
			...
			{field : 'sysCode',title : '系统编号',width : 100,align : 'center',
					formatter : function(value, row, index) {
					if (value == 0) {
						return "<font>本系统</font>";
					} else{
						return value;
					}
				}
			...
			$("#titleImgFile").uploadify({
				'swf' : '<%=basePath %>uploadify/uploadify.swf',
				'fileObjName' : 'uploadify',
				'uploader' : 'info_uploadFile.action;jsessionid='	+ $('#sessionId').val(),
				'buttonText' : '上传图片',
				'height' : 20,
				'width' : 100,
				'multi' : false,
				...
				'onUploadSuccess' : function(file, data, response) {
					$('input[name="info.titleImg"]').val(data);
					
					$("a#prevBtn").attr('href','/nytsyFiles/titleImg/'+data);
					$("a#prevBtn").fancybox();
				}
			});
    	});
		    ...
		    <form id="add_form" method="post" enctype="multipart/form-data">
				...
				<table class="formtable" cellspacing="1" cellpadding="0">
				    ...
				    <tr height="30px">
						...
						<td class="form_value">
					      <input type="file" id="titleImgFile"/>
					      <input type="hidden" name="info.titleImg"/>
					      <div id="fileQueue"></div>
					    </td>
					    <td class="form_value" colspan="2">
					    <a href="javascript:void(0)" class="easyui-linkbutton" id="prevBtn">预览</a>
					    </td>
				    </tr>
			    	<tr height="30px">
