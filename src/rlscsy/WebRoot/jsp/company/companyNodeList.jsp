...
<html>
  <head>
	...
	<script src="${basePath}static/js/hontek/company/companyNode.js" type="text/javascript"></script>
	<!-- 图片显示 -->
  ...
  <input type="hidden" id="entIdStr" value="<%=entIdStr %>">
    ...
    <div class="easyui-layout" data-options="fit:true">   
   		<div data-options="region:'west',title:'节点类型',split:true" style="width:200px;">
    		<ul id="tt"></ul>  

    	</div>   
	    <div data-options="region:'center',title:'流通节点'">
	      <!-- 列表 -->
		   <table id="list_companyNode"></table>  
		    ...
		    <div id="tb" style="height:auto">
				...
				<div>
						&nbsp;&nbsp;
						节点名称: <input class="easyui-validatebox" style="width:150px" id="s_name">&nbsp;&nbsp;
						<!-- 节点类型: <select class="easyui-combobox" style="width:100px;" id="s_flag">&nbsp;&nbsp;
	...
	<!--企业基本信息-->
	<div id="add" class="easyui-window" data-options="iconCls:'icon-house',closed:true" style="width:900px;height:400px;">
		 <div align="center" title="企业基本信息">
			    <form id="add_form" method="post" enctype="multipart/form-data">
			    	<input type="hidden" name="company.comId"><!-- 流通节点Id -->
			    	<input type="hidden" name="company.parentId" value="0"><!-- 流通节点此字段为0 -->
			    	...
			    	<input type="hidden" name="company.nodeAnCom" >
				    ...
				    <table class="formtable" cellspacing="1" cellpadding="0">
				     	<tr height="20px">
						    ...
						    <td class="form_value">
						      <select class="easyui-combobox"   name="company.flag" id="flag" data-options="required:true" style="width:300px;">
						      	<option value=''>--请选择--</option>
						      	<option value='1'>屠宰企业</option>
						      	<option value='2'>批发企业</option>
						      	<option value='3'>菜市场</option>
					    ...
					    <tr height="20px"  class="ifupdate">
					  		<td class="form_label">是否为企业：</td>
						    <td class="form_value" colspan="3">						    
						        <input type="radio" name="nodeAnCom" value="y" onclick="nodeHtml(1)">：是&nbsp;
						 		<input type="radio" name="nodeAnCom" value="" checked="checked" onclick="nodeHtml(0)">：否&nbsp;
						    </td>
					    </tr>	
					    ...
					    <!-- 经营者start-->
					   	<tr height="20px" class="nodeAnCom">
						    ...
						    <td class="form_value">
								<input class="easyui-validatebox" type="text" name="company.account" validType="uniqueAccountName['companyUser_findComUserIsUnique','account','该账户名已经存在']"  style="width: 300px;">
							</td>
					   ...
					   <tr height="20px" class="nodeAnCom">
						...
						<tr height="20px" class="nodeAnCom">
						    ...
						    <td  class="form_value" colspan="3">
					    	<textarea class="easyui-validatebox" name="company.introduction" id="introduction" rows="4"  style="width:100%"></textarea>
					   		</td>
					    </tr>	
		 ...
		 <div align="center" title="节点基本信息">
				    ...
				    <table class="formtable" cellspacing="1" cellpadding="0">
				     	<tr height="20px">
						    ...
						    <td  class="form_label">节点类型：</td>
						    <td class="form_value" style="width:300px" id="d_flag">
						    </td>
					    </tr>
					    ...
					    <tr height="20px">
							...
							<td class="form_label">注册日期：</td>
						    <td class="form_value" id="d_regTime">
						    </td>
					    </tr>	
					    ...
					    <tr height="20px">
						    ...
						    <td  class="form_label">经营者类型：</td>
						    <td class="form_value" id="d_comType">
						    </td>
					    </tr>
					    <tr height="20px">
