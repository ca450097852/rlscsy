	...
	<script type="text/javascript">
		$(function(){		
			...
			$('#datagrid').datagrid({  
				 // title:'投入品购买记录',
				  iconCls : 'icon-table',
			      url:'quarantineInfo_findList.action',//url调用Action方法  
			      queryParams:{"quarantineInfo.ptbId":<%=ptbId%>},
			      loadMsg : '数据装载中......',  			      
			      fit:true,			    
			      ...
			      columns:[[
							...
							{field:'quarantineAnimalProductsId',title:'检疫合格证号',width:100,align:'center'},
							...
							{field:'sampleNum',title:'采样头数',width:50,align:'center'},	
							{field:'sampleId',title:'采样样品编号',width:100,align:'center'},
							{field:'checkDate',title:'抽检日期',width:100,align:'center'}
				      ]],
		          pagination : true,//分页  
		          rownumbers : true,//行数  				          
