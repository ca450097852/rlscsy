		...
		$(function(){
			...
			$('#datagrid').datagrid({  
				 // title:'投入品购买记录',
			      ...
			      queryParams:{"marketInInfoBase.flag":"2","marketInInfoBase.ptbId":<%=ptbId%>},
			      loadMsg : '数据装载中......',  			      
			      fit:true,			    
		 		     ...
		 		     var ddv = $(this).datagrid('getRowDetail',index).find('table.ddv');	 		     
		 		        ...
		 		        ddv.datagrid({
		 		            ...
		 		            columns:[[
		 		                ...
		 		                {field:'wsSupplierId',title:'屠宰厂编码',width:100,align : 'center'},
		 		                {field:'wsSupplierName',title:'屠宰厂名称',width:100,align : 'center'},
