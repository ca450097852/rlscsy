		...
		$(function(){
			...
			$('#datagrid').datagrid({  
				 // title:'投入品购买记录',
			      ...
			      queryParams:{"marketInInfoBase.flag":"4","marketInInfoBase.ptbId":<%=ptbId%>},
			      loadMsg : '数据装载中......',  			      
			      fit:true,			    
			      striped : true,//设置为true将交替显示行背景。  			       
			      fitColumns:true,//允许表格自动缩放，以适应父容器  
			      columns:[[
							{field:'marketId',title:'超市编码',width:50,align:'center'},							
							{field:'marketName',title:'超市名称',width:100,align:'center'},
							{field:'inDate',title:'进场日期',width:100,align:'center'},
							{field:'wholesalerId',title:'供应商编码',width:50,align:'center'},
							{field:'wholesalerName',title:'供应商名称',width:100,align:'center'},
		 		     ...
		 		     var ddv = $(this).datagrid('getRowDetail',index).find('table.ddv');	 		     
		 		        ...
		 		        ddv.datagrid({
		 		            ...
		 		            columns:[[
		 		                ...
		 		                {field:'wsSupplierId',title:'批发市场编码',width:50,align : 'center'},
