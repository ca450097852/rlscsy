	...
	<script type="text/javascript">
		$(function(){		
			...
			$('#datagrid').datagrid({  
				 // title:'投入品购买记录',
				  iconCls : 'icon-table',
			      url:'retailMarketTranInfoSumm_findList.action',//url调用Action方法  
			      queryParams:{"retailMarketTranInfoSumm.flag":"3","retailMarketTranInfoSumm.ptbId":<%=ptbId%>},
			      loadMsg : '数据装载中......',  			      
			      fit:true,			    
			      striped : true,//设置为true将交替显示行背景。  			       
			      fitColumns:true,//允许表格自动缩放，以适应父容器  
			      columns:[[
							{field:'retailMarketId',title:'零售市场编码',width:50,align:'center'},							
							{field:'retailMarketName',title:'零售市场名称',width:100,align:'center'},
							{field:'inDate',title:'进货日期',width:100,align:'center'},
							{field:'saleDate',title:'销售日期',width:50,align:'center'},
							{field:'retailerId',title:'零售商编码',width:100,align:'center'},
							{field:'retailerName',title:'零售商名称',width:100,align:'center'},
							{field:'positionId',title:'零售摊位号',width:100,align:'center'},	
