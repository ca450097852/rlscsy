	...
	<script type="text/javascript">
		$(function(){		
			...
			$('#datagrid').datagrid({  
				 // title:'投入品购买记录',
				  iconCls : 'icon-table',
			      url:'qmarketDetectionInfo_findList.action',//url调用Action方法  
			      queryParams:{"qmarketDetectionInfo.ptbId":<%=ptbId%>},
			      loadMsg : '数据装载中......',  			      
			      fit:true,			    
			      striped : true,//设置为true将交替显示行背景。  			       
			      fitColumns:true,//允许表格自动缩放，以适应父容器  
			      columns:[[
							{field:'marketId',title:'批发市场编码',width:50,align:'center'},							
							{field:'marketName',title:'批发市场名称',width:100,align:'center'},
							{field:'wholesalerId',title:'批发商编码',width:50,align:'center'},
							{field:'wholesalerName',title:'批发商名称',width:100,align:'center'},
							{field:'tranId',title:'交易凭证号',width:100,align:'center'},
							{field:'quarantineAnimalProductsId',title:'动物产品检疫合格证号',width:100,align:'center'},
							{field:'inspectionMeatId',title:'肉品品质检验证号',width:50,align:'center'},	
							{field:'detectionDate',title:'检测日期',width:50,align:'center'}
				      ]],
		          pagination : true,//分页  
		          rownumbers : true,//行数  				          
