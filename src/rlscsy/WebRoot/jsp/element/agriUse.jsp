...
<html>
  <head>
	...
	<script type="text/javascript">
		$(function(){
			//表格数据			
			$('#agriUseDatagrid').datagrid({  
				  //title:'投入品使用记录',
				  iconCls : 'icon-table',
			      url:'agriUse_findAgriUseList.action',//url调用Action方法  
			      queryParams:{"agriUse.recId":<%=recId%>},
			      loadMsg : '数据装载中......',  			      
			      fit:true,			    
			      striped : true,//设置为true将交替显示行背景。  			       
			      fitColumns:true,//允许表格自动缩放，以适应父容器  
			      columns:[[
							{field:'agriName',title:'药品名称',width:100,align:'center'},
							{field:'useObject',title:'防治对象',width:100,align:'center'},
							{field:'useWay',title:'施用方式',width:50,align:'center'},			
							{field:'useDosage',title:'稀释浓度',width:50,align:'center'},			
							{field:'stopDate',title:'施用量',width:50,align:'center'},			
							{field:'useMan',title:'施用人',width:50,align:'center'},
  ...
  <body>
   <!-- 列表 -->
   <table id="agriUseDatagrid"></table>  
