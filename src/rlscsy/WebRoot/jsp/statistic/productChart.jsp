...
<html>
  <head>
	...
	<script src="${basePath}static/js/easyui-1.3.4/locale/easyui-lang-zh_CN.js" type="text/javascript"></script>
	 <script src="${basePath}static/js/hontek/statistic/productChart.js" type="text/javascript"></script>
	<script src="${basePath}static/js/hontek/comm/hontek.js"　type="text/javascript"></script>
	    
    
  </head>
  <body style="padding: 0px" >
  	<div id="p" class="easyui-panel" title="统计产品数量" data-options="iconCls:'icon-chart_curve',fit:true"> 
  			<div>
				...
				&nbsp;&nbsp;时间从: <input class="easyui-datebox" style="width:100px" id="startDate">
				&nbsp;&nbsp;到: <input class="easyui-datebox" style="width:100px" id="endDate">
		...
		<div style="padding: 20px" id="productTable">			
		
		</div>
		
  		 <table id="productChart"></table>  
