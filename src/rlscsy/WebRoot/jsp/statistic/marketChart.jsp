...
<html>
  <head>
	...
	<script src="${basePath}static/js/easyui-1.3.4/locale/easyui-lang-zh_CN.js" type="text/javascript"></script>
	 <script src="${basePath}static/js/hontek/statistic/marketChart.js" type="text/javascript"></script>
	<script src="${basePath}static/js/hontek/comm/hontek.js" type="text/javascript"></script>
	    
    
  </head>
  <body style="padding: 0px" >
  	<div id="p" class="easyui-panel" title="统计销售量" data-options="iconCls:'icon-chart_curve',fit:true"> 
  			<div>
  				&nbsp;&nbsp;图表类型: <select class="easyui-combobox" style="width:120px" id="chartType">
  									 ...
  									 销售量类型：<select class="easyui-combobox" style="width:120px" id="flag">
										<option value="1" selected="selected">屠宰场销售量</option>
										<option value="2" >批发市场销售量</option>
										</select>
		...
		<div style="padding: 20px" id="marketChart">
