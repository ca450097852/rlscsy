...
<script type="text/javascript" src="js/quarantine.js"></script>
	    ...
	    <div class="formtitle"><span>添加档案</span></div>
			<div style="width: 100%" >
	    		...
	    		<td style="width: 65%;" valign="top">
			    	...
			    	<input type="hidden" name="quarantineInfo.ptbId" value="<%=ptbId %>"/>
			    	<input type="hidden" name="quarantineInfo.createTime" />
			    	<input type="hidden" name="quarantineInfo.qiId" />
			    	<input type="hidden" name="quarantineInfo.comId" value="<%=comId %>"/>
			    	<table class="formtable">
			    		<tr>
			    			<td class="form_label">屠宰厂编码</td>
			    			<td class="form_value"><input name="quarantineInfo.butcherFacId"  type="text" value="<%=companyNode. getNodeCode()%>"  class="easyui-validatebox" data-options="required:true"/></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">屠宰厂名称</td>
			    			<td class="form_value"><input name="quarantineInfo.butcherFacName"  type="text" value="<%=companyNode. getName()%>"  class="easyui-validatebox" data-options="required:true"/></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">货主编码</td>
			    			<td class="form_value">
			    				<input name="quarantineInfo.sellerId" type="text" value="<%=company. getComCode()%>" class="easyui-validatebox" data-options="required:true" />
			    			</td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">货主名称</td>
			    			<td class="form_value"><input name="quarantineInfo.sellerName" type="text" value="<%=company. getName()%>" class="easyui-validatebox" data-options="required:true" /></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">产地检疫证号</td>
			    			<td class="form_value"><input name="quarantineInfo.quarantineId" type="text" class="easyui-validatebox" data-options="required:true" /></td>
			    		</tr>
			    	<tr>
			    			<td class="form_label">动物产品检疫合格证号</td>
			    			<td class="form_value"><input name="quarantineInfo.quarantineAnimalProductsId" type="text" class="easyui-validatebox"  data-options="required:true" /></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">肉品品质检验证号</td>
			    			<td class="form_value"><input name="quarantineInfo.inspectionMeatId" type="text" class="easyui-validatebox" /></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">采样头数</td>
			    			<td class="form_value"><input name="quarantineInfo.sampleNum" type="text" class="easyui-validatebox" data-options="required:true" /></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">采样样品编号</td>
			    			<td class="form_value"><input name="quarantineInfo.sampleId" type="text" class="easyui-validatebox" data-options="required:true" /></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">检验员</td>
			    			<td class="form_value"><input name="quarantineInfo.detector" type="text" class="easyui-validatebox" data-options="required:true" /></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">抽检日期</td>
			    			<td class="form_value"><input name="quarantineInfo.checkDate" type="text" class="easyui-datebox"  value="<%=DateUtil.formatDate()%>" id="quarantineInfo_checkDate" data-options="required:true" /></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">阳性头数</td>
			    			<td class="form_value"><input name="quarantineInfo.positiveNum" type="text" class="easyui-validatebox" /></td>
			    		</tr>

			    		<tr>
			    			<td class="form_label">头数</td>
			    			<td class="form_value"><input name="quarantineInfo.checkNum" type="text" class="easyui-validatebox"  /></td>
			    		</tr>
