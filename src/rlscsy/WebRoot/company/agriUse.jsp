...
<script type="text/javascript" src="js/agriUse.js"></script>
    ...
    <div class="center_content3" style="display: none;">
	    ...
	    <div style="width: 100%" >
	    		...
	    		<td style="width: 65%;">
			    	...
			    	<input type="hidden" name="agriUse.crttime"/>
			    	<input type="hidden" name="agriUse.archId"/>
			    	<input type="hidden" name="agriUse.recId" value="<%=recId %>"/>
			    	
			    	<table class="formtable">
		                  <tr>
		                    <td class="form_label" style="width: 150px">药品名称</td>
		                    <td class="form_value"><input name="agriUse.agriName" type="text" id="agriName" class="easyui-combobox" style="width:300px;" maxlength="50" data-options="required:true" /></td>
		                  </tr>		                  
		                  <tr>
		                    <td class="form_label">防治对象</td>
		                    <td class="form_value"><input name="agriUse.useObject" id="useObject" type="text" class="easyui-validatebox" maxlength="50" data-options="required:true" /></td>
		                  </tr>
		                  <tr>
		                    <td class="form_label">施用方法</td>
		                    <td class="form_value">
			                    <select id="useWay" class="easyui-combobox" name="agriUse.useWay" style="width:300px;">   
								    <option value="喷雾">喷雾</option>   
								    <option value="淋洒">淋洒</option>   								    
								</select>  		             		                    
		                  </tr>
		                  		                  <tr>
		                    <td class="form_label">使用剂量</td>
		                    <td class="form_value"><input name="agriUse.useDosage" type="text" class="easyui-validatebox" maxlength="50" data-options="required:true" /></td>
		                  </tr>
		                  		                  
		                  <tr>
		                    <td class="form_label">施用量</td>
		                    <td class="form_value"><input name="agriUse.useTotal" id="useTotal" type="text" class="easyui-validatebox" style="width:300px;" data-options="required:true"/></td>
		                  </tr>
		                  		                  <tr>
		                    <td class="form_label">施用人</td>
		                    <td class="form_value"><input name="agriUse.useMan" id="useMan" type="text" class="easyui-validatebox" style="width:300px;"/></td>
		                  </tr>
		                  <tr>
		                    <td class="form_label">使用日期</td>
		                    <td class="form_value"><input name="agriUse.useDate" id="useDate" type="text" class="easyui-datebox" style="width:300px;" data-options="required:true"/></td>
		                  </tr>

		                  	<tr>
		                    <td class="form_label">安全隔离天数</td>
		                    <td class="form_value"><input name="agriUse.safeDay" id="safeDay" type="text" class="easyui-numberbox" style="width:300px;"/></td>
		                  </tr>
		                  <tr>
		                    <td class="form_label">安全采收期</td>
		                    <td class="form_value"><input name="agriUse.safeDate" id="safeDate" type="text" class="easyui-datebox" style="width:300px;"/></td>
		                  </tr>
