...
<script type="text/javascript" src="js/meatOutInfoBase_tz.js"></script>
	    		...
	    		<td style="width: 65%;" valign="top">
			    	...
			    	<table class="formtable">
			    		...
			    		<tr>
			    			...
			    			<td class="form_value"><input name="meatOutInfoBase.sellerName" type="text" value="<%=company. getName()%>" class="easyui-validatebox" data-options="required:true" /></td>
			    		</tr>
			    		<tr>
			    		...
			    		<tr>
			    			...
			    			<td class="form_value"><input name="meatOutInfoBase.tranId" id="tranId" type="text" class="easyui-validatebox" readonly="readonly" /></td>
			    		</tr>
