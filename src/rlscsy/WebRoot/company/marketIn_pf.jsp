	    		...
	    		<td style="width: 65%;" valign="top">
			    	...
			    	<table class="formtable">
			    		...
			    		<tr>
			    			...
			    			<td class="form_value"><input name="marketInInfoBase.transporterId" type="text" class="easyui-validatebox" data-options="required:true" /></td>
			    		</tr>
			    		<tr>
