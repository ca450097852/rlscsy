...
<script type="text/javascript" src="js/processUse.js"></script>
...
<body>
    ...
    <div id='proDiv'>
	    <table id="proTab" class="tablelist">
	    	<thead>
	    	<tr>
	        <th width="25%">投入品名称</th>
	        <th width="15%">使用日期</th>	        
	        <th width="15%">投入品使用量</th>
	        <th width="15%">创建日期</th>
	        <th width="20%">操作</th>
	        </tr>
	        </thead>
	    ...
	    <div style="width: 100%" >
	    		...
	    		<td style="width: 65%;">
	    			<form id="recordForm" method="post">
				    	<input type="hidden" name="processUse.puId"/>
				    	<input type="hidden" name="processUse.crttime"/>
				    	<input type="hidden" name="processUse.userId"/>
				    	<input type="hidden" name="processUse.recId" value="<%=recId %>"/>
				    	<input type="hidden" name="processUse.puImg"/>
				    	<table class="formtable">
				    		...
				    		<tr>
			                    <td class="form_label" style="width: 150px">投入品名称</td>
			                    <td class="form_value"><input name="processUse.puName" type="text" class="easyui-validatebox" style="width:300px;" maxlength="50" data-options="required:true" /></td>
			                  </tr>
			                  
			                  <tr>
			                    <td class="form_label" style="width: 150px">使用日期</td>
			                    <td class="form_value"><input name="processUse.useTime" id="useTime" type="text" class="easyui-datebox" style="width:300px;" maxlength="50" data-options="required:true" /></td>
			                  </tr>
			                  <tr>
			                    <td class="form_label" style="width: 150px">投入品使用量</td>
			                    <td class="form_value"><input name="processUse.useTotal" type="text" class="easyui-validatebox" style="width:300px;" maxlength="50" data-options="required:true" /></td>
			                  </tr>
			                  
			                  <tr>
			                    <td class="form_label">备注</td>
			                    <td class="form_value"><input name="processUse.remark"  type="text" class="easyui-validatebox" style="width:300px;"/></td>
			                  </tr>
