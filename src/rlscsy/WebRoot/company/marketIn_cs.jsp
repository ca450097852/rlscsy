			...
			<div style="width: 100%" >
	    		...
	    		<td style="width: 65%;" valign="top">
			    	...
			    	<table class="formtable">
			    		<tr>
			    			<td class="form_label">超市编码</td>
			    			<td class="form_value"><input name="marketInInfoBase.marketId" value="<%=companyNode.getNodeCode()%>" type="text"  class="easyui-validatebox" data-options="required:true"/></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">超市名称</td>
			    		...
			    		<tr>
			    			...
			    			<td class="form_value"><input name="marketInInfoBase.wholesalerName" value="<%=company.getName()%>" type="text" class="easyui-validatebox" data-options="required:true" /></td>
			    		</tr>
			    		<tr>
