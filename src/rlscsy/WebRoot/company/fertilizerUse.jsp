...
<script type="text/javascript" src="js/fertilizerUse.js"></script>
	    ...
	    <div class="formtitle"><span>添加档案</span></div>
			<div style="width: 100%" >
	    		...
	    		<td style="width: 65%;" valign="top">
	    			...
	    			<input type="hidden" name="fertilizerUse.recId" value="<%=recId %>"/>
	    			<input type="hidden" name="fertilizerUse.fuid" value="0"/>
	    			<input type="hidden" name="fertilizerUse.crttime" />
			    	<table class="formtable">
			    		<tr>
			    			<td class="form_label" width="150px">肥料名称</td>
			    			<td class="form_value"><input name="fertilizerUse.funame"  id="fertilizerUse_funame" type="text"  style="width: 300px" data-options="required:true" /></td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">施用目的</td>
			    			<td class="form_value">
			    				<input name="fertilizerUse.purpose" type="text" class="easyui-validatebox"  data-options="required:true" />
			    			</td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">施用面积</td>
			    			<td class="form_value">
			    				<input name="fertilizerUse.userarea" type="text" class="easyui-validatebox"  />
			    			</td>
			    		</tr>
			    		...
			    		<tr>
			    			...
			    			<td class="form_value">
			    				<input name="fertilizerUse.usedate" id="s_usedate" type="text" class="easyui-datebox" style="width:300px;" data-options="required:true" />
			    			</td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">施用量</td>
			    			<td class="form_value">
			    				<input name="fertilizerUse.usertotal" type="text" class="easyui-validatebox"  data-options="required:true" />
			    			</td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">施用人</td>
			    			<td class="form_value">
			    				<input name="fertilizerUse.useman" type="text" class="easyui-validatebox"  data-options="required:true" />
			    			</td>
			    		</tr>
			    		<tr>
			    			<td class="form_label">备注</td>
			    			<td class="form_value">
			    				<textarea name="fertilizerUse.remark" id="s_remark" class="easyui-validatebox"  style="width: 300px;height: 100px;"></textarea>
			    			</td>
			    		</tr>
