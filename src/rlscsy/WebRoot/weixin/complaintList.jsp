...
<title>广东省农产品质量安全监管追溯平台-投诉举报列表</title>
...
<script src="<%=basePath %>weixin/js/complaintList.js" type="text/javascript"></script>		
	...
	<DIV class="CENTER">
        <div class="CENTER_content">
        	<div class="CENTER_content_left">
            	<div class="product_title"><img src="images/tousu.png" /> <font>投诉举报列表</font></div>
                <div class="news_list" >
                	<ul id="news_list">
                    	<!-- 信息列表部份 -->
                    </ul>
