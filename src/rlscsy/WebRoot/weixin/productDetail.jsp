...
<script src="<%=basePath %>weixin/js/productDetail.js" type="text/javascript"></script>		
	...
	<div class="CENTER">
        <div class="CENTER_content">
        	<div class="CENTER_content_left">
            	<div class="product_title"><img src="images/icon.png" /> <font>产品详情</font></div>
                <div class="product_detail">
                	<div class="product_detail_img" id="proimg"></div>
                    <div class="product_detail_text" id="ptable">
